...
//! * [`NoobQ::default`] builds the noob-vst-webgui-framework bridge through
//!   `NoobVstWebguiFrameworkEditor::with_builder`: the adapter mirrors the nih-plug
//!   parameters into noob-vst-webgui-framework specs (65-point tables carry nih-plug's skewed
...
//!   lives in noob-vst-webgui-framework's UI store and is persisted through
...
impl ClapPlugin for NoobQ {
    const CLAP_ID: &'static str = "io.github.noob-audio-engineering.noob-q";
