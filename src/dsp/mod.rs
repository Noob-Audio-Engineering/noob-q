...
/// both; only the tapers differ in flavour (noob-vst-webgui-framework's `log` here, nih-plug's
...
/// Build the noob-vst-webgui-framework bridge for the standalone binary: manifest meta
...
/// `noob_vst_webgui_framework_nih::NoobVstWebguiFrameworkEditor::with_builder`, which mirrors the nih-plug
