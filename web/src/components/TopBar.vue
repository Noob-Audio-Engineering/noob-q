 ...
 * in `@noob-audio-engineering/noob-vst-webgui-framework`, not here), `stats.echoAvgMs` (measured by the client
...
import { loadState, ui, useNoobVstWebguiFramework } from '../composables/useNoobVstWebguiFramework.js';
import { FACTORY_PRESETS, loadUserPresets } from '../presets.js';
import { Popover } from '@noob-audio-engineering/noob-vst-webgui-framework/vue';
import PresetBrowser from './PresetBrowser.vue';
import { ContextMenu } from '@noob-audio-engineering/noob-vst-webgui-framework/vue';

const { history, historyState, connected, stats, status } = useNoobVstWebguiFramework();
