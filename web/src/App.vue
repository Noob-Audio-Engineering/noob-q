...
import { allBands, deleteBand, hasParam, selectBands, ui, useGlobals, useNoobVstWebguiFramework } from './composables/useNoobVstWebguiFramework.js';
...
import { LevelMeter } from '@noob-audio-engineering/noob-vst-webgui-framework/vue';
